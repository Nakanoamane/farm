export const fieldsOptions = {
  ...
  corn1: {
    ...
    growSec: 10,
    items: {
      sickle: { field: 'plowed', items: { cornKernel: 1 } },
    }
  },
  corn2: {
    image: 'corn2',
  ...
  corn3: {
    image: 'corn3',
    items: {
      sickle: { field: 'plowed', items: { cornKernel: 2, corn: 1 }, addScore: true },
    }
  },
  poultry1: {
    image: 'poultry1',
  ...
  bee2: {
    ...
    growSec: 30,
    items: {
      hand: { field: 'bee1', items: { honey: 1 }, addScore: true }
    }
  },
  bee3: {
    image: 'bee3',
    items: {
      hand: { field: 'bee1', items: { bee: 2 }, addScore: true }
    }
  },
};
